...
const deviceConnectionString = "IOTHUB_DEVICE_CONNECTION_STRING";
...
function generateMessage () {
  ...
  const data = JSON.stringify({ deviceId: 'simulator', windSpeed: windSpeed, temperature: temperature, humidity: humidity });
  const message = new Message(data);
  // Set message body type and content encoding, or else base64 is by default
